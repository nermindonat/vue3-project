<template>
  <div class="flex flex-col md:flex-row items-center p-4 md:p-12">
    <div
    ...
    <div class="flex-1 p-4 md:p-12">
      <h2
        class="font-normal text-3xl md:text-5xl leading-8 md:leading-10 mb-4 md:mb-8"
      >
        Fikirlerin Gerçeğe Dönüşümü
      </h2>
